...
function Doctorr() {
  ...
  const handleAddDoctor = (newDoctor) => {
    ...
    axios.post(' http://16.171.155.145:5000/doctors', newDoctor)
      .then((response) => {
  ...
  useEffect(() => {
    axios.get(' http://16.171.155.145:5000/Doctorr')
      .then((response) => {
  ...
  const handleDeleteDoctor = (doctorId) => {
    ...
    axios.delete(`http://16.171.155.145:5000/doctors/${doctorId}`)
      .then(() => {
  ...
  const handleEditDoctor = (editedDoctor) => {
    ...
    axios.put(`http://16.171.155.145:5000/doctors/${editedDoctor.id}`, editedDoctor)
      .then(() => {
